...
import static com.emorinken.order.domain.OrderAsserts.*;
import static com.emorinken.order.web.rest.TestUtil.createUpdateProxyForBean;
import static com.emorinken.order.web.rest.TestUtil.sameNumber;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.emorinken.order.IntegrationTest;
...
class OrderResourceIT {
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.bookIsbn(UPDATED_BOOK_ISBN).quantity(UPDATED_QUANTITY).totalPrice(UPDATED_TOTAL_PRICE);
