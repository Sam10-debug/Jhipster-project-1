...
import static com.emorinken.review.web.rest.TestUtil.createUpdateProxyForBean;
...
class ReviewResourceIT {
    ...
    @Test
    @Transactional
    void checkReviewTextIsRequired() throws Exception {
    ...
    void partialUpdateReviewWithPatch() throws Exception {
        ...
        partialUpdatedReview.reviewText(UPDATED_REVIEW_TEXT).reviewerName(UPDATED_REVIEWER_NAME).bookIsbn(UPDATED_BOOK_ISBN);
